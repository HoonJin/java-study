package com.hoonjin.study.spring.advanced.proxy.jdkdynamic;
...
public class ReflectionTest {
    ...
    void reflection1() throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Class<?> classHello = Class.forName("com.hoonjin.study.spring.advanced.proxy.jdkdynamic.ReflectionTest$Hello");
